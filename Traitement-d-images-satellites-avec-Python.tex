...
\begin{verbatim}
valeurs : [0.11111111 0.11111111 0.08888889 0.12222222 0.16666667 0.06666667
 0.12222222 0.05555556 0.12222222 0.14444444]
...
\pandocbounded{\includegraphics[keepaspectratio]{02-RehaussementVisualisationImages_files/figure-pdf/cell-13-output-1.pdf}}
...
d'une image cible de façon à ce que la distribution cumulée des valeurs
...
chaque valeur de pixel est équiprobable, ce qui veut dire \$
hist\_\{cible\}(j)=1/L\$ avec \(L\) est le nombre de valeurs possibles
dans l'image (par exemple \(L=256\)). \[
j = L \times CDF_{source}(i)
\] On peut appliquer cette procédure sur l'image SAR de la façon
suivante:
...
\CommentTok{\#.with\_extremes(over=\textquotesingle{}red\textquotesingle{}, under=\textquotesingle{}blue\textquotesingle{})}
