...
\begin{verbatim}
valeurs : [0.18888889 0.11111111 0.06666667 0.12222222 0.07777778 0.07777778
 0.17777778 0.05555556 0.13333333 0.1       ]
...
\pandocbounded{\includegraphics[keepaspectratio]{02-RehaussementVisualisationImages_files/figure-pdf/cell-12-output-1.pdf}}
...
\NormalTok{percentiles}\OperatorTok{=}\NormalTok{ np.percentile(values, percentiles\_position)}
...
\pandocbounded{\includegraphics[keepaspectratio]{02-RehaussementVisualisationImages_files/figure-pdf/cell-14-output-1.pdf}}
...
\texttt{np.linspace(percentiles{[}1{]},percentiles{[}-2{]},\ 50)} où
percentiles{[}1{]} et percentiles{[}-2{]} sont les \(2\%\) et \(98\%\)
percentiles respectivement:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{hist, bin\_edges }\OperatorTok{=}\NormalTok{ np.histogram(values, }
\NormalTok{                                bins}\OperatorTok{=}\NormalTok{np.linspace(percentiles[}\DecValTok{1}\NormalTok{], }
\NormalTok{                                percentiles[}\OperatorTok{{-}}\DecValTok{2}\NormalTok{], }\DecValTok{50}\NormalTok{), }
...
\pandocbounded{\includegraphics[keepaspectratio]{02-RehaussementVisualisationImages_files/figure-pdf/cell-15-output-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-TransformationSpatiales_files/figure-pdf/cell-6-output-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-TransformationSpatiales_files/figure-pdf/cell-10-output-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-TransformationSpatiales_files/figure-pdf/cell-12-output-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-TransformationSpatiales_files/figure-pdf/cell-14-output-3.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-TransformationSpatiales_files/figure-pdf/cell-15-output-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-TransformationSpatiales_files/figure-pdf/cell-17-output-3.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-TransformationSpatiales_files/figure-pdf/cell-18-output-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-TransformationSpatiales_files/figure-pdf/cell-19-output-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{04-TransformationSpatiales_files/figure-pdf/cell-21-output-2.pdf}}
