...
cela, on peut utiliser le (\textbf{?@lst-numpyshape}), dont le résultat
nous informe que la matrice a trois dimensions et une taille de
...
le type de la donnée comme indiqué dans le (\textbf{?@tbl-numpytype})
(voir aussi
