\documentclass[11pt]{article}
    ...
    % Document parameters
    % Document title
    \title{05-ClassificationsSupervisees}
...
\begin{document}
    ...
    \hypertarget{sec-chap05}{%
\section{Classifications d'images supervisées}\label{sec-chap05}}
...
\PY{err}{!}\PY{n}{pip} \PY{n}{install} \PY{o}{\PYZhy{}}\PY{n}{qU} \PY{n}{matplotlib} \PY{n}{rioxarray} \PY{n}{xrscipy}
\end{Verbatim}
\end{tcolorbox}
...
ExtraSamples.
    ...
    \hypertarget{sec-051}{%
\subsection{Classification d'images pixel par pixel}\label{sec-051}}

\hypertarget{sec-0511}{%
\subsubsection{Parallélépipède}\label{sec-0511}}

\hypertarget{sec-0512}{%
\subsubsection{Méthodes paramétriques}\label{sec-0512}}

\hypertarget{sec-0513}{%
\subsubsection{Méthodes non paramétriques}\label{sec-0513}}

\hypertarget{sec-0514}{%
\subsubsection{SVEM, réseaux de neurones, forêts
aléatoires}\label{sec-0514}}

\hypertarget{sec-052}{%
\subsection{Segmentation d'images}\label{sec-052}}

\hypertarget{sec-0521}{%
\subsubsection{Classification objet}\label{sec-0521}}

\hypertarget{sec-0522}{%
\subsubsection{Approches par arbre (BPT, etc.)}\label{sec-0522}}

\hypertarget{sec-054}{%
\subsection{Exercices de révision}\label{sec-054}}
