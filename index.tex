...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, coltitle=black, left=2mm, titlerule=0mm, breakable, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-important-color!10!white, colback=white, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, bottomtitle=1mm, arc=.35mm, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, rightrule=.15mm, colframe=quarto-callout-important-color-frame]
...
{\centering \includegraphics{images/xarray-dataset-diagram.png}
...
\begin{verbatim}
valeurs : [0.06666667 0.05555556 0.11111111 0.07777778 0.14444444 0.15555556
 0.11111111 0.15555556 0.1        0.13333333]
...
\begin{tcolorbox}[enhanced jigsaw, toptitle=1mm, coltitle=black, left=2mm, titlerule=0mm, breakable, opacityback=0, opacitybacktitle=0.6, colbacktitle=quarto-callout-note-color!10!white, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, bottomtitle=1mm, arc=.35mm, leftrule=.75mm, bottomrule=.15mm, toprule=.15mm, rightrule=.15mm, colframe=quarto-callout-note-color-frame]
...
simples est la méthode SLIC (Sup), elle combine un regroupement de type
K-moyenne avec une distance hybride qui prend en compte les différences
de couleur mais aussi la distance au centre du super-pixel:
...
\ImportTok{from}\NormalTok{ skimage.segmentation }\ImportTok{import}\NormalTok{ slic}
\ImportTok{from}\NormalTok{ skimage.segmentation }\ImportTok{import}\NormalTok{ mark\_boundaries}
...
\includegraphics{04-TransformationSpatiales_files/figure-pdf/cell-20-output-2.png}

compactness=30, n\_segments=400, \#\# Vectorisation et rasterisation
