...
```
La précision pour une classe donnée est la proportion des prédictions qui sont de bonnes prédictions et est sensible aux fausses alarmes alors que le `recall` (le rappel) est la portion des vrais prédictions qui ont été bien classifiées et est sensible aux confusions entre classes.
